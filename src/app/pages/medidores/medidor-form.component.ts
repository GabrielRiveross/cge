...
export class MedidorFormComponent implements OnInit {
  ...
  form = this.fb.group({
    codigo_medidor: this.fb.control<string>('', { validators: [Validators.required, Validators.minLength(1)] }),
    id_cliente: this.fb.control<number | null>(null, { validators: [Validators.required] }),
    direccion_suministro: this.fb.control<string>('', { validators: [Validators.required] }),
    latitud: this.fb.control<number | null>(null, { validators: [Validators.min(-90), Validators.max(90)] }),
    longitud: this.fb.control<number | null>(null, { validators: [Validators.min(-180), Validators.max(180)] }),
    estado: this.fb.control<boolean>(true)
  });
