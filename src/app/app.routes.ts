...
import { ClienteMedidoresMapaComponent } from './pages/clientes/cliente-medidores-mapa.component';
...
export const routes: Routes = [
  ...
  {
    path: 'clientes/:id_cliente/medidores-mapa',
    component: ClienteMedidoresMapaComponent,
  },
